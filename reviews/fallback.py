...
FALLBACK_BY_LANGUAGE: dict[str, list[tuple[str, list[str]]]] = {
    ...
    "marathi": [
        ("casual", [
            "इथे आलो आणि बरं वाटलं.",
            "Staff नीट होतं आणि सगळं properly सांगितलं.",
            "जागा clean होती आणि नीट maintained होती.",
        ...
        ("enthusiastic", [
            ...
            "Staff helpful आहे आणि नीट लक्ष देतं.",
            "Quality दर वेळी सारखीच असते.",
            "जागा एकदम clean आहे.",
            "जे हवं होतं ते मिळालं.",
            "पुढेही नक्की येणार.",
        ]),
        ("formal", [
            "एकदम छान अनुभव होता.",
            "Staff नीट बोललं आणि व्यवस्थित attend केलं.",
            "Quality जशी हवी होती तशीच होती.",
            "जागा clean आणि नीट होती.",
            "Bill पण लवकर आणि नीट झालं.",
            "मित्रांना पण सांगेन.",
        ]),
    ],
}
